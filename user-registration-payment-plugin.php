...
add_shortcode( 'angelfss_user_registration_and_payment_form', 'urp_register_form_shortcode' );

function urp_shortcode_instructions_page() {
    ?>
    <div class="wrap">
        <h1>Shortcode Instructions</h1>
        <p>Welcome to the Shortcode Instructions page! Below is the shortcode that can be used on any page to display the user registration form.</p>
        ...
        <div style="border: 2px dashed #0073aa; padding: 20px; background-color: #f9f9f9;">
            ...
            <pre>[angelfss_user_registration_and_payment_form]</pre>
            <p>This shortcode will show the registration form along with the payment gateway options. Simply paste this shortcode into any page or post, and the form will appear there.</p>
        </div>
    </div>
    <?php
}
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="number" name="urp_registration_fee" value="<?php echo esc_attr(get_option('urp_registration_fee')); ?>" required /></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <select name="urp_payment_gateway" required>
                            <option value="paypal" <?php selected(get_option('urp_payment_gateway'), 'paypal'); ?>>PayPal</option>
                            <option value="stripe" <?php selected(get_option('urp_payment_gateway'), 'stripe'); ?>>Stripe</option>
                            <option value="paystack" <?php selected(get_option('urp_payment_gateway'), 'paystack'); ?>>Paystack</option>
                        </select>
                    </td>
                </tr>
